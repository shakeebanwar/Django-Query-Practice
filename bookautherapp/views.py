...
class books(APIView):
    def get(self,request):
        ...
        # bookes = Book.objects.filter(published__lte=F("author__b irth_date") + datetime.timedelta(days=365*19)).values()
        ...
        # bookes = Book.objects.annotate(author_age=F("published") - F("author__birth_date")).values("author_age")
